...
OAA_BEARER = os.getenv(
    "OAA_BEARER", ""
)  # optional; if set, GET endpoints can require it
...
@router.get("/list")
def list_echo_pulses(limit: int = 10, _: None = Depends(require_bearer)):
